                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="{{route('admin.users.edit',Auth::user()->id)}}" class="btn btn-warning btn-mini">Sửa</a>
                                        <a href="{{route('admin.editPassword',Auth::user()->id)}}" class="btn btn-warning btn-mini">đổi mật khẩu</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
