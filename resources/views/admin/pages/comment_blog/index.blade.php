                            ...
                            <table class="table table-bordered table-striped" id="table_id">
                                ...
                                @foreach($comments as $key=>$comment)
                                    <tr>
                                        ...
                                        <td>{{$comment->com}}</td>
                                        <td>http://127.0.0.1:8000/{{$comment->blog->slug}}</td>
                                        <td class="center">
                                            ...
                                            <form id="delete-from-{{$comment->id}}" action="{{route('admin.comment-blog.destroy',$comment->id)}}" method="POST" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
