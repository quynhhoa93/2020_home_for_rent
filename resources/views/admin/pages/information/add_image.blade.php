                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{route('admin.postInformationImages')}}" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
                                @csrf
                ...
                @foreach($informationImages as $key=>$informationImage)
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <form id="delete-from-{{$informationImage->id}}" action="{{route('admin.deleteAltImage',$informationImage->id)}}" method="POST" style="display:none;">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
